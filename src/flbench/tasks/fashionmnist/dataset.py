...
def create_datasets(
    ...
    base_train = datasets.FashionMNIST(root=root, train=True, download=True, transform=train_tf)
    base_train_noaug = datasets.FashionMNIST(root=root, train=True, download=False, transform=test_tf)
